...
handoffs:
  - label: Create BRD
    ...
    prompt: Document the business requirements for this initiative
  - label: Create PRDs
    agent: productkit.prd
    prompt: Create detailed PRDs for each phase of this Epic
  - label: Break into Tasks
    agent: productkit.tasks
    prompt: Break this Epic into sprint-ready tasks
---
